@echo off 
echo =======================AppScanX Clean Script for Windows=======================
...
echo Deleting AppScanX migrations
...
echo Deleting AppScanX data directory: %mobsf_home%
del /f "%mobsf_home%" /q /s >nul 2>&1
echo Done
) ELSE ( 
echo Please run script from appscanx.AppScanX directory
